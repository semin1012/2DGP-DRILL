...
# Boy Event
RIGHT_DOWN, LEFT_DOWN, RIGHT_UP, LEFT_UP, SHIFT_DOWN, SHIFT_UP, DASH_TIMER, SLEEP_TIMER = range(8)
# fill here
...
next_state_table = {
    ...
    DashState: {SHIFT_UP: RunState, SHIFT_DOWN: DashState, LEFT_UP: RunState, RIGHT_UP: RunState, LEFT_DOWN: RunState, RIGHT_DOWN: RunState, DASH_TIMER: RunState}
}
