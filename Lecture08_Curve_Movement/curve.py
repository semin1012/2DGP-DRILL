...
def blend_lines(p1, p2, p3, p4):
    ...
    for i in range(0, 100, 2):
        ...
        x = (1-t)*lx + t*rx     # 곡선이 나옴
        y = (1-t)*ly + t*ry     # 곡선이 나옴
...
def draw_line(p1, p2):
    ...
    for i in range(0, 100, 2):      # t값이 2까지 (같은 방향으로 2배로 이동)
        t = i / 100     # i는 파이 값?
        x = (1-t)*x1 + t*x2
        y = (1-t)*y1 + t*y2
        draw_point((x, y))
...
p3 = x3, y3 = random.randint(-300, -300), random.randint(-300, -100)
...
# draw_curve_4_points(p1, p4, p2, p3)
