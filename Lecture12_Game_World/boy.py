...
class DashState:
    ...
    def enter(boy, event):
        print('ENTER DASH')     # 대쉬 상태 잘 들어가지는지 확인
        boy.dir = boy.velocity
        boy.dash_timer = 100

    def exit(boy, event):
        print('EXIT DASH')      # 대쉬 상태 잘 나가는지 확인
        pass
...
next_state_table = {
    DashState: {SHIFT_UP: RunState, DASH_TIMER: RunState, RIGHT_UP: IdleState, RIGHT_DOWN: IdleState,
                LEFT_UP: IdleState, LEFT_DOWN: IdleState},

    IdleState: {RIGHT_UP: RunState, LEFT_UP: RunState, RIGHT_DOWN: RunState, LEFT_DOWN: RunState,
                SLEEP_TIMER: SleepState, SHIFT_UP: IdleState, SHIFT_DOWN: IdleState, SPACE: IdleState},
    ...
    SleepState: {LEFT_DOWN: RunState, RIGHT_DOWN: RunState, LEFT_UP: RunState, RIGHT_UP: RunState,
                 SHIFT_DOWN: SleepState, SHIFT_UP: SleepState, SPACE: IdleState}
}
