...
BALL_PIXEL_PER_METER = 21.0 / 0.3
BALL_SPEED_KMPH = 200
BALL_SPEED_MPM = BALL_SPEED_KMPH * 100.0 / 60.0
BALL_SPEED_MPS = BALL_SPEED_MPM / 60.0
BALL_SPEED_PPS = BALL_SPEED_MPS * BALL_PIXEL_PER_METER
...
class Boy:
    ...
    def fire_ball(self):
        ball = Ball(self.x, self.y, self.dir*BALL_SPEED_PPS)
